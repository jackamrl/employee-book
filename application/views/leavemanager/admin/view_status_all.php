...
function nottaken_con() {
 var answer = confirm("Are you sure that this leave has not taken");
 if (answer) {
  return true;
 }
 ...
 return false;
					...
					<tr>
                        <th style="width:35px; padding:5px; " class="hidden-tablet hidden-phone">S.No.</th>
                            ...
                            <th style="width:298px; padding:5px;">Action</th>
                            <?php } ?>
                        </tr>
                       <?php 
		$i=0;
...
<a href="#" class="btn btn-primary" id="<?php echo $i; ?>" onclick="more();" >More</a>
 ...
 ?>
    ...
    <div class="clear"></div>
   <?php /*?> <?php echo $this->load->view('footer'); ?><?php */?>
        <script type="text/javascript">
