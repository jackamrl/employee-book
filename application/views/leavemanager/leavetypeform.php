...
echo form_open('leavemanager/leave/add_leave_type', $attributes); ?>
<div class="control-group">
    <label for="type_of_leave" class="control-label">Leave Type <span class="required">*</span></label>
	<div class='controls'>
       <input id="type_of_leave" type="text" name="type_of_leave" maxlength="255" value="<?php echo set_value('type_of_leave'); ?>"  />
